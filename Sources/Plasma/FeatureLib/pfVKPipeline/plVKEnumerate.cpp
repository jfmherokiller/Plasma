...
bool fillDeviceRecord2(hsG3DDeviceRecord& devRec)
{
...
void plWVKEnumerate(std::vector<hsG3DDeviceRecord>& records)
{
    ATOM cls = 0;
    HWND wnd = nullptr;
    HDC dc = nullptr;
...
void plVKEnumerate::Enumerate(std::vector<hsG3DDeviceRecord>& records)
{
#ifdef USE_EGL
